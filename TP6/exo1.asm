...
data segment
    ...
    qst1 db "Entrez le nombre : ", "$" ; Question pour quider l'utilisateur
    number db 5 dup (?) ; Initialisation du tableau permettant de stocker le nombre à convertir
data ends
...
debut: 
    ...
    MOV DS, AX
take_number:
    LEA DX, number ; Récupération de l'offset du tableau number
    MOV AX, 0Ah ; Instruction pour entrée une chaîne de carractère. 
...
convert_loop:
    ...
    ADD AL, "0" ; Convertission en ASCII - Pas encore les bonnes valeurs
